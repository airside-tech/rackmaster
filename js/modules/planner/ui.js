...
import {
    ...
    initializeSelectedComponentColorPalette as initializeSelectedComponentColorPaletteView,
    updateSelectedComponentPaletteSelection as updateSelectedComponentPaletteSelectionView
...
import {
    ...
    renderSelectedComponentPanel as renderSelectedComponentPanelView,
...
export function createPlannerUi(context) {
    ...
    function renderSelectedComponentPanel() {
        renderSelectedComponentPanelView({
            getSelectedRackComponent,
            getComponentDisplayColor,
            getComponentRangeLabel,
    ...
    function updateSelectedComponentPaletteSelection(colorHex) {
        updateSelectedComponentPaletteSelectionView({ selectedComponentColorPresetsEl }, colorHex);
    }

    function initializeSelectedComponentColorPalette() {
        initializeSelectedComponentColorPaletteView({
            colorPresets,
            selectedComponentColorPresetsEl,
            selectedComponentFields,
            getSelectedRackComponent,
